...
- Do not hand-edit floating version tags or pinned SHAs when the change is intended to pin or refresh an action dependency; run `pinact` instead and review the resulting diff.

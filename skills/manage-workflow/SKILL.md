...
2. **Branch & PR Rules**:
   ...
   - Route PR preparation and bounded post-PR follow-up through `review-task`; use the **PR template** with this fallback order: current repo `.github/PULL_REQUEST_TEMPLATE.md` → workspace root repo `/home/yoske/src/github.com/yoskeoka/vibe-coding-workspace/.github/PULL_REQUEST_TEMPLATE.md` → child repo `.claude/vendor/workflow/.github/PULL_REQUEST_TEMPLATE.md` → workflow repo `.github/PULL_REQUEST_TEMPLATE.md`

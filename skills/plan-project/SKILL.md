...
**Position in workflow**: This is **Step 1** of the AI-Centered Development cycle. After completing the project plan, proceed to Step 2 (Execution Plan) to break work into actionable tasks.
...
After the project plan is defined, proceed to **Execution Plan** (Step 2): create task plans in `docs/exec-plan/todo/` to break the work into implementable units.

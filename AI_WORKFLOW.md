...
- Activities:
    ...
    3. Go/No-Go decision
- Before asking what to do next after a non-trivial intake checkpoint, compress the current findings into `docs/issues/<name>.md` with the preserved problem framing, conclusion, next questions, and source links so later sessions can resume without replaying the full research context.

...
- For a non-blocked PR creation or update flow, the minimum landing path is: `commit -> push -> PR create/update -> 30-second wait -> initial follow-up poll`, with checks, timeline events, review summaries, and inline comments inspected from that poll.

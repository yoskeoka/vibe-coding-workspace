...
- Human-review handoffs should end with a compact separate-session prompt that future PR follow-up for that branch should continue in a new session. Keep it to about 3 lines and include the PR number, branch name, and requested follow-up scope.
